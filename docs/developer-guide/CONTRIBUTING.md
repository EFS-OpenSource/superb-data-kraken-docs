...
The SDK operates an open contribution model where everyone may contribute
...
1. [Create a topic branch](git-commands.md/#create-topic-branch) \
Check out a new branch based on the development branch (see [branching conventions](branching-guidelines.md/#branching)) according to the [branch naming conventions](branching-guidelines.md/#naming).
...
3. [Commit patches](git-commands.md/#commit-patches) and when ready, [push to the remote branch](git-commands.md/#push-to-the-remote-branch)
4. [Squash commits](https://git-scm.com/docs/git-rebase) to a single feature commit with a meaningful [commit message](git-commit-guidelines.md)
...
Fill out the [pull request template](pull-request-template.md) and perform a [self-review](pull-request-template.md/#self-review). 
...
Anyone may participate in peer review and comment pull requests. The central criteria follow the [self-review](pull-request-template.md/#self-review) checklist.
